...
function classify(raws2, accounts, manual, decisions) {
  ...
  return { events: events2, questions: questions2, receivables, movements };
}
...
var { questions, events } = classify(raws, ACCOUNTS, [MANUAL_CASH_PURCHASE], {});
console.log("\u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432 \u0431\u0435\u0437 \u0440\u0435\u0448\u0435\u043D\u0438\u0439: " + questions.length);
console.log("\u0440\u0430\u0441\u0445\u043E\u0434\u044B \u0434\u043E \u0440\u0430\u0437\u0431\u043E\u0440\u0430: " + expenses(events, sep2) / 100 + " \u20BD");
console.log("\n\u0442\u043E\u043F-5 \u043E\u0447\u0435\u0440\u0435\u0434\u0438 (\u043F\u043E\u0440\u044F\u0434\u043E\u043A = \u043F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442):");
questions.slice(0, 5).forEach((q, i) => console.log(" " + (i + 1) + ". " + (q.changesTotals ? "[\u043C\u0435\u043D\u044F\u0435\u0442 \u0438\u0442\u043E\u0433] " : "[\u043E\u0431\u044A\u0451\u043C]      ") + q.title + "  \u2014 " + q.body));
